...
# то ли надо разбить на 6 отдельных таблиц, то ли выбирать из единой, все равно сформирована.
# наверное надо ввести цикл в РСА, перебирая по номерам концентраций (делая срезы)
# и цикл в регрессию... данные из регрессий взять в таблицу, и по ней найти максимум.
# как брать срез по значению?) кажется на лекции было.